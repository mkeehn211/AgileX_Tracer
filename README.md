...
Always have your remote controller ready to take over the control whenever necessary. You can switch the SWA switch to control mode (middle state) to stop velocity commands from CAN communication.
